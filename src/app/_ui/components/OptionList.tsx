...
const correctAnswerBadge = (
  <div className="bg-brand-paris-green text-white px-3 py-2 flex items-center justify-center space-x-2 rounded-[53px]">
    <Tick />
    <p className="text-xs font-medium font-jakarta">Correct answer</p>
  </div>
);

const wrongAnswerBadge = (
  <div className="bg-brand-bittersweet-dark text-white px-3 py-2 flex items-center justify-center space-x-2 rounded-[53px]">
    <Close />
    <p className="text-xs font-medium font-jakarta">Your answer</p>
  </div>
);
    ...
    <div className="flex flex-col items-start space-y-1">
      {options?.map((option, idx) => (
        ...
        >
          ...
          <p className="text-base font-normal text-brand-midnight">{option}</p>
